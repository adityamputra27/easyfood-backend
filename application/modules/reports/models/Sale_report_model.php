...
class Sale_report_model extends CI_Model
{
  ...
  var $column_order = array('t.transaction_date');
  var $column_search = array('t.transaction_date', 't.invoice');
  var $order = array('t.transaction_date' => 'DESC');
  ...
  {
    $this->db->select('t.id, t.invoice, t.transaction_date, t.discount, t.status, u.name as nama_kasir, t.total');
    ...
    if ($this->input->post('start_date') && $this->input->post('end_date')) {
      ...
      $this->db->where("t.transaction_date BETWEEN '" . $start_date . " 00:00:00' AND '" . $end_date . " 23:59:59'");
    }
