      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="table-responsive">
            <table id="reportStockIn" class="table table-bordered table-striped">
              <thead>
                <tr>
...
<script>
  $(function() {
    let tableReportStockIn = $('#reportStockIn').DataTable({
      "language": {
      ...
      "order": [],
      "ajax": {
        "url": "<?= base_url() ?>reports/stock_in/getStockInReport",
        "type": "POST",
        "data": function(data) {
    ...
    $(document).on('click', '#btn-filter', function(e) {
      tableReportStockIn.ajax.reload()
    })
